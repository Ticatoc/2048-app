...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"description","content":"2048 puzzle game built with Nuxt and Nuxt UI"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[],"noscript":[],"title":"2048 Game"};
